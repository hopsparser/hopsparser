...
class BiAffineParser(nn.Module):
    ...
    def __init__(self,
        ...
        self.rnn           = nn.LSTM(self.lexer.embedding_size+char_rnn.word_embedding_size,mlp_input,1, batch_first=True,dropout=encoder_dropout,bidirectional=True).to(self.device)
