...
| ud_gsd_flaubert | French| GPU  | xxxx | average| Flaubert + UD French GSD     | [download model](http://www.linguist.univ-paris-diderot.fr/~bcrabbe/depmodels/gsd_flaubert.tar.gz) 
