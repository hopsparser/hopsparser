...
| ---------- | -------- | ------ | ---- | -----  | ------- | -------------
|   default  | French   | GPU/CPU| 82.6 | fast   | French treebank only          | [download model](http://www.linguist.univ-paris-diderot.fr/~bcrabbe/depmodels/default.tar.gz)
...
| of_default | Old French| GPU/CPU  | 78.7 | fast | SCMRF treebank only     | [download model](http://www.linguist.univ-paris-diderot.fr/~bcrabbe/depmodels\
/of_default.tar.gz)
